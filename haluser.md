...
## 🎨 WARNA (sesuai logo biru tua & orange)

Rekomendasi aman:

* **Primary**: Biru Tua → header, navbar
* **Secondary**: Orange → CTA, badge aktif
* **Background**: Abu muda / putih
* **Success**: Hijau lembut
* **Warning**: Kuning

➡️ Tampilan **hangat + terpercaya**, cocok food app

---

## 🔐 FLOW LOGIN (UX HALUS, TIDAK MAKSA)

| Kondisi             | UX                  |
| ------------------- | ------------------- |
| Lihat menu          | ❌ Tidak perlu login |
| Tambah ke keranjang | ❌ Tidak perlu       |
| Checkout            | 🔔 Tawari login     |
| Lihat riwayat       | ✅ Wajib login       |
| Review              | ✅ Wajib login       |

Dialog checkout:

> “Masuk agar pesanan tersimpan dan bisa diberi ulasan”

---

## 🧠 KESIMPULAN

✔️ Mirip ShopeeFood **secara rasa**, bukan kompleksitas
✔️ Mudah diimplementasi di Svelte
✔️ Login **punya alasan jelas**
✔️ Review valid & terkontrol

Kalau mau, aku bisa lanjutkan ke:

* **Wireframe teks per halaman**
* **Komponen Svelte (Card, Badge, Empty State)**
* **Flow khusus akun toko**
* **Prompt Cursor: build UI ini otomatis**
